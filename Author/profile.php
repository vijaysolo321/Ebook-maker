...
<div class="sidebar">
    ...
    <ul class="nav-links">
      ...
      <li>
        <a href="../ebookcreate.php">
          <i class='bx bx-plus'></i>
          <span class="links_name">Add ebook</span>
        </a>
      </li>
      <!-- <li>
        <a href="#">
        ...
        <div class="recent-sales box">
          ...
          <div class="sales-details">
            <form action="./update_profile.php" method="post" autocomplete="nope">
                  ...
                  <input class="admin-profile-form-text" autocomplete="nope" type="number" name="number" value="<?php echo $arr1['author_phone_no'];?>" placeholder="Enter your number" required>
